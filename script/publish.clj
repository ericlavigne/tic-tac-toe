...
(let [repo (git/load-repo ".")
  ...
  (clojure.java.shell/sh "mkdir" "images")
  (clojure.java.shell/sh "cp" "resources/public/images/o.png" "images/o.png")
  (clojure.java.shell/sh "cp" "resources/public/images/x.png" "images/x.png")
  (clojure.java.shell/sh "cp" "resources/public/images/empty.png" "images/empty.png")
  (git/git-add repo "images/o.png")
  (git/git-add repo "images/x.png")
  (git/git-add repo "images/empty.png")
